"""
Vellore Ward 60 (VIT University) Seed Script — JanVedha AI
======================================================
Seeds everything needed to test Vellore Ward 60 (VIT University):

1. Ward 1060 departments (D01–D14 with ward_id=1060)
2. Users:
   - 1 Supervisor
   - 1 Councillor
   - 14 Junior Engineers
3. Sample tickets for Vellore (VIT University area)
"""
import asyncio
import os
import sys
...
WARD_ID = 1060
WARD_NAME = "Ward 60 - VIT University (Vellore)"
PASSWORD = "password123"

SUPERVISOR = {
    "name": f"Ward 60 Supervisor Vellore",
...
COUNCILLOR = {
    "name": f"Ward 60 Councillor Vellore",
...
JUNIOR_ENGINEERS = [
    {
        "name": f"JE {dept['dept_name']} W60 VLR",
    ...
    SAMPLE_TICKETS = [
        {
            ...
            "source": "WEB_PORTAL",
            "description": "Deep potholes on the main road outside VIT Main Gate. It is causing severe traffic for students and staff.",
            "dept_id": "D01",
            "issue_category": "general_complaint",
            "ward_id": WARD_ID,
            "location_text": f"VIT Main Gate, Vellore",
            "location": {"lat": 12.9692, "lng": 79.1559, "address": f"VIT University Main Gate, Vellore, Tamil Nadu"},
        ...
        },
        {
            "ticket_code": ticket_code(),
            "source": "WEB_PORTAL",
            "description": "Water leaking from main supply pipe near Men's Hostel Block.",
            "dept_id": "D03",
            "issue_category": "general_complaint",
            "ward_id": WARD_ID,
            "location_text": f"Men's Hostel Block, VIT, Vellore",
            "location": {"lat": 12.9711, "lng": 79.1620, "address": f"Men's Hostel Block, VIT University, Vellore, Tamil Nadu"},
        ...
        },
        {
            "ticket_code": ticket_code(),
            "source": "WEB_PORTAL",
            "description": "Garbage dump lying uncleaned for 4 days near Food Court.",
            "dept_id": "D05",
            "issue_category": "general_complaint",
            "ward_id": WARD_ID,
            "location_text": f"Food Court Area, VIT, Vellore",
            "location": {"lat": 12.9730, "lng": 79.1590, "address": f"Food Court Area, VIT University, Vellore, Tamil Nadu"},
        ...
        },
        {
            "ticket_code": ticket_code(),
            "source": "WEB_PORTAL",
            "description": "Streetlights on the route from Green Pearl to Library are completely off.",
            "dept_id": "D06",
            "issue_category": "general_complaint",
            "ward_id": WARD_ID,
            "location_text": f"VIT Library Road, Vellore",
            "location": {"lat": 12.9740, "lng": 79.1600, "address": f"Library Road, VIT University, Vellore, Tamil Nadu"},
        ...
        },
        {
            "ticket_code": ticket_code(),
            "source": "WEB_PORTAL",
            "description": "Sewage water overflowing into the streets in low-lying area near Women's Hostel.",
            "dept_id": "D04",
            "issue_category": "general_complaint",
            "ward_id": WARD_ID,
            "location_text": f"Women's Hostel, VIT, Vellore",
            "location": {"lat": 12.9750, "lng": 79.1630, "address": f"Women's Hostel, VIT University, Vellore, Tamil Nadu"},
...
async def main():
    ...
    print("\n" + "=" * 60)
    print("[DONE] Seed complete for Vellore VIT Ward!")
    client.close()
